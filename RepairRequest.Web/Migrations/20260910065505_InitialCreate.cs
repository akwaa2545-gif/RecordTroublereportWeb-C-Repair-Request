...
namespace RepairRequest.Web.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestNumber = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: false),
                    ...
                    AssignedUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairRequests_RequesterId_CreatedUtc",
                table: "RepairRequests",
                columns: new[] { "RequesterId", "CreatedUtc" });
